...
var types = {
    loginFailed: function (data) {
        return generate('User provide unmatched login properties', 'LoginFailed', codes.LOGIN_FAILED, data);
    },
    unauthorized: function (data) {
        return generate('User is not authorized to perform this action', 'Unauthorized', codes.UNAUTHORIZED, data);
    },
    authTokenExpired: function (data) {
        return generate('Your session has expired, please login again', 'AuthTokenExpired', codes.AUTH_TOKEN_EXPIRED, data);
    },
    authTokenInvalid: function (data) {
        return generate('Your session is no longer valid, please login again', 'AuthTokenInvalid', codes.AUTH_TOKEN_INVALID, data);
    },
    notImplemented: function (data) {
        return generate('Not implemented', 'NotImplemented', codes.NOT_IMPLEMENTED, data);
    },
    ...
    readonly: function (data) {
        return generate('Read-only session, data not updated', 'ReadOnlySession', codes.READONLY_SESSION, data);
    }
};
module.exports = {
    codes: codes,
